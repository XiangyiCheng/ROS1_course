...
int main(int argc, char **argv) {
    ros::init(argc, argv, "vel_publisher"); // name of this node will be "vel_cmd_publisher"
    ros::NodeHandle n; // two lines to create a publisher object that can talk to ROS
    ros::Publisher my_publisher_object = n.advertise<std_msgs::Float64>("pos_cmd", 1);
    ros::Publisher my_publisher_object2 = n.advertise<std_msgs::Float64>("pos_cmd2", 1);
